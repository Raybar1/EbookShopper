...
function validarP(){
  ...
  var passaux = 'Admin123';
  console.log(passaux);
  if (passadmin != passaux) {
...
function passadmin(){
    ...
    var aux = LoginResponse;

    alert(aux["nombreUsuario"]);
}
...
function addBolsa(){
  ...
  var url = 'http://localhost:8080/auth/agregaBolsa';
    var data =    {
      "modelo":modelo,
      "precio": precio,
      "imagen":imagenS,
...
function deleteBolsa(){
  let modelo = document.getElementById("modelo").value;
  var url = 'http://localhost:8080/auth/borraBolsa';
    var data =    {
      "modelo":""+modelo
  }
...
function PutBolsa(){
  ...
  var url = 'http://localhost:8080/auth/modificaBolsa';
    var data =    {
      "modelo":modelo,
      "precio": precio,
      "imagen":imagen,
...
var url = 'http://localhost:8080/auth/hacerPedido';
fetch(url, {
  method: 'POST',
  body: JSON.stringify(data),
  headers: {
